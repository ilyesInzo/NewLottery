...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        File file = new File(
                Main.class.getClassLoader().getResource("histories.json").getFile());
    ...
    static Jackpot displayWinnerEuro(boolean isFoundStar, List<Integer> lastStartList, List<List<Integer>> lastList) {
    ...
    static Jackpot displayWinner6Aus49(boolean isFoundStar, List<Integer> lastStartList, List<List<Integer>> lastList) {
        Random rand = new Random();
    ...
    private static void GetResult(boolean isFoundStar, List<Integer> lastStartList, Random rand, List<Integer> baseList,
    ...
    private static int whenToWin(List<Integer> winningChain, List<Integer> winningStarChain, int numberFound,
    ...
    private static Jackpot getSpinJackpotResult(Lottery lottery, boolean isFoundStar, List<Integer> lastStartList,
    ...
    private static void displayWinningBestOccurrence(List<Integer> allPossibleWinningNumbers, int limit) {
    ...
    private static void checkHistory(Lottery lottery, List<Integer> winningNumber) {
